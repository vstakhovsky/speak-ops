/**
SpeakOps: Anatomy of an AI-Ready Voice Activation OS
**/
...
│
├── skills/                              # Claude Code Skills (primary definitions)
│   ├── phrase-extractor/                # Extract phrases from sources
│   │   ├── SKILL.md                     # Skill definition
│   │   ├── evals/                       # Skill-specific evals
...
│   └── GITHUB_PROFILE_SETUP.md         # GitHub repository setup
│
